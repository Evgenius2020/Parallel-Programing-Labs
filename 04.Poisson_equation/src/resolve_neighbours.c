                        ...
                        MPI_Datatype column_datatype)
{
    ...
    {
        MPI_Send(local_data.rho_matrix, 1,
    ...
    {
        MPI_Send(local_data.rho_matrix + local_data.matrix_width - 1, 1,
    ...
    {
        MPI_Send(local_data.rho_matrix, local_data.matrix_width,
    ...
    else
    {
        ...
        MPI_Send(local_data.rho_matrix + last_line, local_data.matrix_width,
